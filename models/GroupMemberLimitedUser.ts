...
/**
 * Check if a given object implements the GroupMemberLimitedUser interface.
 */
export function instanceOfGroupMemberLimitedUser(value: object): value is GroupMemberLimitedUser {
    return true;
}

export function GroupMemberLimitedUserFromJSON(json: any): GroupMemberLimitedUser {
    return GroupMemberLimitedUserFromJSONTyped(json, false);
}

export function GroupMemberLimitedUserFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupMemberLimitedUser {
    if (json == null) {
        return json;
    }
    return {
...
export function GroupMemberLimitedUserToJSON(value?: GroupMemberLimitedUser | null): any {
    if (value == null) {
        return value;
    }
    return {
