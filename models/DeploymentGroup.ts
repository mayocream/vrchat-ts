...
export function instanceOfDeploymentGroup(value: any): boolean {
    for (const key in DeploymentGroup) {
        if (Object.prototype.hasOwnProperty.call(DeploymentGroup, key)) {
            if (DeploymentGroup[key as keyof typeof DeploymentGroup] === value) {
                return true;
            }
        }
    }
...
export function DeploymentGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeploymentGroup {
    return json as DeploymentGroup;
}
