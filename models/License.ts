...
import type { LicenseAction } from './LicenseAction';
import {
    LicenseActionFromJSON,
    LicenseActionFromJSONTyped,
    LicenseActionToJSON,
} from './LicenseAction';
...
export function instanceOfLicense(value: object): value is License {
    if (!('forId' in value) || value['forId'] === undefined) return false;
    if (!('forType' in value) || value['forType'] === undefined) return false;
    if (!('forName' in value) || value['forName'] === undefined) return false;
    if (!('forAction' in value) || value['forAction'] === undefined) return false;
    return true;
}
...
export function LicenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): License {
    ...
    return {
        ...
        'forId': json['forId'],
        'forType': LicenseTypeFromJSON(json['forType']),
        'forName': json['forName'],
        'forAction': LicenseActionFromJSON(json['forAction']),
    };
}
...
export function LicenseToJSON(value?: License | null): any {
    ...
    return {
        ...
        'forId': value['forId'],
        'forType': LicenseTypeToJSON(value['forType']),
        'forName': value['forName'],
        'forAction': LicenseActionToJSON(value['forAction']),
    };
}
