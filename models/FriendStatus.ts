 ...
 */
export function instanceOfFriendStatus(value: object): value is FriendStatus {
    if (!('incomingRequest' in value) || value['incomingRequest'] === undefined) return false;
    if (!('isFriend' in value) || value['isFriend'] === undefined) return false;
    if (!('outgoingRequest' in value) || value['outgoingRequest'] === undefined) return false;
    return true;
}
