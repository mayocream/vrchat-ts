...
/**
 * Check if a given object implements the LimitedGroup interface.
 */
export function instanceOfLimitedGroup(value: object): value is LimitedGroup {
    return true;
}

export function LimitedGroupFromJSON(json: any): LimitedGroup {
    return LimitedGroupFromJSONTyped(json, false);
}

export function LimitedGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): LimitedGroup {
    if (json == null) {
        return json;
    }
    return {
...
export function LimitedGroupToJSON(value?: LimitedGroup | null): any {
    if (value == null) {
        return value;
    }
    return {
