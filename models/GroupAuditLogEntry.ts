...
/**
 * Check if a given object implements the GroupAuditLogEntry interface.
 */
export function instanceOfGroupAuditLogEntry(value: object): value is GroupAuditLogEntry {
    return true;
}

export function GroupAuditLogEntryFromJSON(json: any): GroupAuditLogEntry {
    return GroupAuditLogEntryFromJSONTyped(json, false);
}

export function GroupAuditLogEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupAuditLogEntry {
    if (json == null) {
        return json;
    }
    return {
        ...
        'actorDisplayName': json['actorDisplayName'] == null ? undefined : json['actorDisplayName'],
...
export function GroupAuditLogEntryToJSON(value?: GroupAuditLogEntry | null): any {
    if (value == null) {
        return value;
    }
    return {
