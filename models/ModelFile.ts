...
export function ModelFileFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelFile {
    ...
    return {
        ...
        'tags': json['tags'],
        'versions': (new Set((json['versions'] as Array<any>).map(FileVersionFromJSON))),
    };
}
...
export function ModelFileToJSON(value?: ModelFile | null): any {
    ...
    return {
        ...
        'id': value['id'],
        'mimeType': MIMETypeToJSON(value['mimeType']),
        'name': value['name'],
        'ownerId': value['ownerId'],
        'tags': value['tags'],
        'versions': (Array.from(value['versions'] as Set<any>).map(FileVersionToJSON)),
    };
}
