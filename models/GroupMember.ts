...
import type { GroupMemberLimitedUser } from './GroupMemberLimitedUser';
import {
    GroupMemberLimitedUserFromJSON,
    GroupMemberLimitedUserFromJSONTyped,
    GroupMemberLimitedUserToJSON,
} from './GroupMemberLimitedUser';
...
export function GroupMemberFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupMember {
    ...
    return {
        ...
        'user': json['user'] == null ? undefined : GroupMemberLimitedUserFromJSON(json['user']),
...
export function GroupMemberToJSON(value?: GroupMember | null): any {
    ...
    return {
        ...
        'user': GroupMemberLimitedUserToJSON(value['user']),
