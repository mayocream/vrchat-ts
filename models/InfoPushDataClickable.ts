...
/**
 * Check if a given object implements the InfoPushDataClickable interface.
 */
export function instanceOfInfoPushDataClickable(value: object): value is InfoPushDataClickable {
    if (!('command' in value) || value['command'] === undefined) return false;
    return true;
}

export function InfoPushDataClickableFromJSON(json: any): InfoPushDataClickable {
    return InfoPushDataClickableFromJSONTyped(json, false);
}

export function InfoPushDataClickableFromJSONTyped(json: any, ignoreDiscriminator: boolean): InfoPushDataClickable {
    if (json == null) {
        return json;
    }
    return {
...
export function InfoPushDataClickableToJSON(value?: InfoPushDataClickable | null): any {
    if (value == null) {
        return value;
    }
    return {
