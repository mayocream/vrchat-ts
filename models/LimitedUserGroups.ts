...
/**
 * Check if a given object implements the LimitedUserGroups interface.
 */
export function instanceOfLimitedUserGroups(value: object): value is LimitedUserGroups {
    return true;
}

export function LimitedUserGroupsFromJSON(json: any): LimitedUserGroups {
    return LimitedUserGroupsFromJSONTyped(json, false);
}

export function LimitedUserGroupsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LimitedUserGroups {
    if (json == null) {
        return json;
    }
    return {
        ...
        'memberVisibility': json['memberVisibility'] == null ? undefined : json['memberVisibility'],
        'isRepresenting': json['isRepresenting'] == null ? undefined : json['isRepresenting'],
        'mutualGroup': json['mutualGroup'] == null ? undefined : json['mutualGroup'],
        'lastPostReadAt': json['lastPostReadAt'] == null ? undefined : (new Date(json['lastPostReadAt'])),
    };
}

export function LimitedUserGroupsToJSON(value?: LimitedUserGroups | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'memberVisibility': value['memberVisibility'],
        'isRepresenting': value['isRepresenting'],
        'mutualGroup': value['mutualGroup'],
