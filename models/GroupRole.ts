...
export function GroupRoleFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupRole {
    ...
    return {
        ...
        'isManagementRole': json['isManagementRole'] == null ? undefined : json['isManagementRole'],
        'requiresTwoFactor': json['requiresTwoFactor'] == null ? undefined : json['requiresTwoFactor'],
        'requiresPurchase': json['requiresPurchase'] == null ? undefined : json['requiresPurchase'],
