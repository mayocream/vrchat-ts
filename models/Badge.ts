...
export function instanceOfBadge(value: object): value is Badge {
    if (!('badgeDescription' in value) || value['badgeDescription'] === undefined) return false;
    if (!('badgeId' in value) || value['badgeId'] === undefined) return false;
    if (!('badgeImageUrl' in value) || value['badgeImageUrl'] === undefined) return false;
    if (!('badgeName' in value) || value['badgeName'] === undefined) return false;
...
export function BadgeToJSON(value?: Badge | null): any {
    ...
    return {
        ...
        'assignedAt': value['assignedAt'] == null ? undefined : ((value['assignedAt'] as any).toISOString()),
