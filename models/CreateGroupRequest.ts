...
import type { GroupRoleTemplate } from './GroupRoleTemplate';
import {
    GroupRoleTemplateFromJSON,
    GroupRoleTemplateFromJSONTyped,
    GroupRoleTemplateToJSON,
} from './GroupRoleTemplate';
...
export function instanceOfCreateGroupRequest(value: object): value is CreateGroupRequest {
    ...
    if (!('roleTemplate' in value) || value['roleTemplate'] === undefined) return false;
    return true;
}
...
export function CreateGroupRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateGroupRequest {
    ...
    return {
        ...
        'roleTemplate': GroupRoleTemplateFromJSON(json['roleTemplate']),
    };
}
...
export function CreateGroupRequestToJSON(value?: CreateGroupRequest | null): any {
    ...
    return {
        ...
        'roleTemplate': GroupRoleTemplateToJSON(value['roleTemplate']),
    };
}
