...
export function instanceOfSubscription(value: object): value is Subscription {
    ...
    if (!('steamItemId' in value) || value['steamItemId'] === undefined) return false;
...
export function SubscriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Subscription {
    ...
    return {
        ...
        'id': json['id'],
        'steamItemId': json['steamItemId'],
        'oculusSku': json['oculusSku'] == null ? undefined : json['oculusSku'],
        'googleProductId': json['googleProductId'] == null ? undefined : json['googleProductId'],
        'googlePlanId': json['googlePlanId'] == null ? undefined : json['googlePlanId'],
        'picoSku': json['picoSku'] == null ? undefined : json['picoSku'],
        'amount': json['amount'],
...
export function SubscriptionToJSON(value?: Subscription | null): any {
    ...
    return {
        ...
        'oculusSku': value['oculusSku'],
        'googleProductId': value['googleProductId'],
        'googlePlanId': value['googlePlanId'],
        'picoSku': value['picoSku'],
        'amount': value['amount'],
