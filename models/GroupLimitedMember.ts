...
/**
 * Check if a given object implements the GroupLimitedMember interface.
 */
export function instanceOfGroupLimitedMember(value: object): value is GroupLimitedMember {
    return true;
}

export function GroupLimitedMemberFromJSON(json: any): GroupLimitedMember {
    return GroupLimitedMemberFromJSONTyped(json, false);
}

export function GroupLimitedMemberFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupLimitedMember {
    if (json == null) {
        return json;
    }
    return {
        ...
        'bannedAt': json['bannedAt'] == null ? undefined : (new Date(json['bannedAt'])),
...
export function GroupLimitedMemberToJSON(value?: GroupLimitedMember | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'bannedAt': value['bannedAt'] == null ? undefined : ((value['bannedAt'] as any).toISOString()),
